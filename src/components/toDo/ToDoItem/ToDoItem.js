...
const ToDoItem = ({id,completed, description, handleChange, deleteItem}) => {
    ...
    return (
        <div className="flex items-center pb-6 pl-5" >
            <div className="hover:text-hovered_checkbox">
                ...
                />
                <label htmlFor={"checkbox"+id} className="ml-4 cursor-pointer " 
            ...
            <div 
                ...
                onClick={deleteItem}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-4 h-4 mb-1 hover:text-red-700">
