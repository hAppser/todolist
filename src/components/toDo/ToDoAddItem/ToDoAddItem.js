...
const ToDoAddItem = ({addTask}) => {
    ...
    return(
        <div className="flex justify-between items-center w-input h-14 mt-8 mb-12 border rounded-lg" >
            ...
            />
            <button className="bg-mavi text-white h-11 px-6 py-3 m-1.5 rounded" 
                onClick={e => {
                    addTask(userTask)
                    setUserTask('')
                }}
